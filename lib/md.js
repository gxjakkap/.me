...
export async function mdToHTML(markdownContent) {
    ...
    const processor = rehype().data('settings', {fragment: true}).use(addclasses, {h2: "text-xl sm:text-xl md:text-2xl lg:text-2xl", a: "underline", img: "ml-auto mr-auto rounded-xl", p: "text-lg"})
