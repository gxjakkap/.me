...
export const metadataTemplate = (argument: MetadataTemplateArguments): Metadata => {
  const socialTitle = argument.addSiteNameInSocialTitle
    ? `${argument.title} - jakka`
    : argument.title
  const socialDefaultImage =
    "https://res.cloudinary.com/dynrld3nm/image/upload/f_auto,q_auto,w_300/guntxjakka.me/me_2024.jpg"
  return {
