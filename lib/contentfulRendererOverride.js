...
function Im(inp) {
    ...
    return <img style={{marginTop: '1.25rem', marginBottom: '1.25rem', maxWidth: '70vw', maxHeight: '550px', marginLeft: 'auto', marginRight: 'auto' /* , borderRadius: '0.5rem' */}} src={file.url} alt={title} />
}
...
const overrideOptions = {
    ...
    [BLOCKS.HEADING_2]: {
        component: Heading2,
        props: {
            style: {marginBottom: '0.75rem', marginTop: '2.5rem', fontSize: '1.75rem', lineHeight: '2.5rem'}
        }
    },
    [BLOCKS.HEADING_3]: {
        component: Heading3,
        props: {
            style: {marginBottom: '0.75rem', marginTop: '2.5rem', fontSize: '1.5rem', lineHeight: '2.25rem'}
        }
    },
}
