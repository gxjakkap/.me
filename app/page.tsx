...
export default function Home() {
  ...
  return (
    <main className="flex flex-col flex-grow mx-auto lg:ml-[25%] lg:mr-0 pt-4 lg:pt-10 lg:mt-14 w-3/4 lg:w-1/2">
      ...
      <section className="flex flex-col pb-6 lg:pb-52 lg:gap-y-32" id="main">
          <div className="flex flex-col-reverse lg:flex-row gap-x-8">
            <div className="flex flex-col-reverse lg:flex-col my-8">
                ...
                <div className="flex mx-auto my-2 gap-x-6">
                    <button className="bg-[#3333331a] text-[#333333] border-0 rounded-lg cursor-pointer inline-block font-inter font-medium text-base leading-5 list-none m-0 px-3 py-3 text-center align-baseline whitespace-nowrap select-none touch-manipulation"><Link href={'/projects'}>What I did</Link></button>
                    <button className="bg-[#3333331a] text-[#333333] border-0 rounded-lg cursor-pointer inline-block font-inter font-medium text-base leading-5 list-none m-0 px-3 py-3 text-center align-baseline whitespace-nowrap select-none touch-manipulation"><Link href={'/contact'}>Contact me</Link></button>
                </div>
            </div>
          ...
          <div className="flex flex-col mx-auto text-[#525a5e] text-sm text-center cursor-pointer">
            <Link href={"#more"}>
              <p className="font-inter">Scroll down to learn more about me</p>
              <ChevronDoubleDownIcon className="w-7 mx-auto" />
            </Link>
          </div>
      </section>
        ...
        <div>
          <div className="relative pl-8 sm:pl-32 py-6 group">
              <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-[#393042] after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                  ...
                  <div className="text-xl font-bold text-slate-900">Secondary & High School</div>
              </div>
              <div className="flex flex-col">
                <span className="text-[#313638] font-medium"><a href="https://psuwit.ac.th/">PSU.Wittayanusorn School</a></span>
                  <span className="text-[#525a5e]">Hat Yai, Thailand</span>
              </div>
          </div>
          <div className="relative pl-8 sm:pl-32 py-6 group">
              <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-[#393042] after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                  ...
                  <div className="text-xl font-bold text-slate-900">Bachelor's degree (current)</div>
              </div>
              <div className="flex flex-col">
                  <span className="text-[#313638] font-medium"><a href="https://kmutt.ac.th/">King Mongkut's University of Technology Thonburi</a></span>
                  <span className="text-[#525a5e]"><a href="https://www.cpe.kmutt.ac.th/en/">B.Eng, Computer Engineering</a></span>
                  <span className="text-[#525a5e]">Bangkok, Thailand</span>
              </div>
          </div>
        </div>
      </section>
